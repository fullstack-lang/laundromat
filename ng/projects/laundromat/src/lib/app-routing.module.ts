...
const routes: Routes = [ // insertion point for routes declarations
	...
	{ path: 'github_com_fullstack_lang_laundromat_go-machine-adder/:id/:originStruct/:originStructFieldName', component: MachineDetailComponent, outlet: 'github_com_fullstack_lang_laundromat_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_laundromat_go-simulation-adder/:id/:originStruct/:originStructFieldName', component: SimulationDetailComponent, outlet: 'github_com_fullstack_lang_laundromat_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_laundromat_go-washer-adder/:id/:originStruct/:originStructFieldName', component: WasherDetailComponent, outlet: 'github_com_fullstack_lang_laundromat_go_editor' },
