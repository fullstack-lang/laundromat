...
import (
	...
	"github.com/fullstack-lang/laundromat/go/events"
...
func NewSimulation() (simulation *Simulation) {
	...
	// attach simulation to the gongsim generic simulation engine
...
func (simulation *Simulation) CreateInitialEvents() {
	...
	simulation.Washer.QueueUpdateEvent(1 * time.Second)
	...
	simulation.Machine.QueueUpdateEvent(1 * time.Second)
}
